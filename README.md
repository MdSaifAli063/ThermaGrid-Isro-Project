...
- **Multi-sensor ingest**: Integrates multiple satellite feeds into a single 30 m thermal stack.
- **LST detection**: Brightness-temperature inversion with emissivity correction over neighborhood polygons.
- **PINN + SHAP**: Physics-informed network enforcing surface energy balance with SHAP attribution.
- **Cooling optimizer**: Counterfactual scenarios across cooling interventions ranked by ΔT, capex, and CO₂ offset.
